...
\graphicspath{{./}{main/p.1038/}{main/p.1038/Images/}{Images/}}
\makeatletter
\def\@maketitle{%
  \begin{center}
  \vspace*{1cm}
...
\begin{center}
\subfloat[]
{\includegraphics[width=8cm,height=5cm]{main//p.1038//Images/reg.png}}\qquad
\subfloat[]
{\includegraphics[width=5cm,height=5cm]{main//p.1038//Images/studyarea2.png}}
\vspace{-4mm}  
...
\begin{figure}[!ht]
    \begin{center}
        \subfloat[]
            {\includegraphics[width=4cm,height=4cm]{main//p.1038//Images/plotX.eps}}\quad
            \subfloat[]
             {\includegraphics[width=4cm,height=4cm]{main//p.1038//Images/plotY.eps}}\quad
             \subfloat[]
            {\includegraphics[width=4cm,height=4cm]{main//p.1038//Images/plotZ.eps}}
            \vspace{-4mm}        
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=6cm]{main//p.1038//Images/khfront.eps}
\vspace{-6mm}  
...
\begin{figure}[!ht]
	\begin{center}
		\subfloat[]
		{\includegraphics[width=3.8cm,height=4cm]{main//p.1038//Images/105.eps}}
		\subfloat[]
		{\includegraphics[width=3.8cm,height=4cm]{main//p.1038//Images/118.eps}}
		\subfloat[]
		{\includegraphics[width=3.8cm,height=4cm]{main//p.1038//Images/124.eps}}
		\subfloat[]
		{\includegraphics[width=3.8cm,height=4cm]{main//p.1038//Images/137.eps}}\vspace{-4mm}        
