...
\graphicspath{{./}{main/p.1243/}{main/p.1243/Images/}{Images/}}
\makeatletter
\def\@maketitle{%
  \begin{center}
  \vspace*{1cm}
...
\thispagestyle{empty}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/gr17_gnn_confusion_matrix}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/eil51_gnn_confusion_matrix}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/berlin52_gnn_confusion_matrix}\\[0.3em]
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/gr17_gnn_roc_auc}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/eil51_gnn_roc_auc}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/berlin52_gnn_roc_auc}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/gr17_svm_confusion_matrix}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/eil51_svm_confusion_matrix}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/berlin52_svm_confusion_matrix}\\[0.3em]
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/gr17_svm_roc_auc}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/eil51_svm_roc_auc}
		\includegraphics[width=0.32\textwidth]{main//p.1243//figures/berlin52_svm_roc_auc}
